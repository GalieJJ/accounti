...
EU_STEUERSAETZE: dict[str, SteuersatzInfo] = {
    ...
    "DE": SteuersatzInfo(
        ...
        land_name_en="Germany",
        normal=Decimal("19"),
        ermaessigt=Decimal("7"),
    ),
    "FR": SteuersatzInfo(
        land_code="FR",
        ...
        land_name_en="France",
        normal=Decimal("20"),
        ermaessigt=Decimal("5.5"),
        ermaessigt_2=Decimal("10"),
        super_ermaessigt=Decimal("2.1"),
    ),
    "NL": SteuersatzInfo(
        land_code="NL",
        land_name="Niederlande",
        land_name_en="Netherlands",
        normal=Decimal("21"),
        ermaessigt=Decimal("9"),
    ),
    "BE": SteuersatzInfo(
        land_code="BE",
        land_name="Belgien",
        land_name_en="Belgium",
        normal=Decimal("21"),
        ermaessigt=Decimal("6"),
        ermaessigt_2=Decimal("12"),
    ),
    "LU": SteuersatzInfo(
        land_code="LU",
        land_name="Luxemburg",
        land_name_en="Luxembourg",
        normal=Decimal("17"),
        ermaessigt=Decimal("8"),
        super_ermaessigt=Decimal("3"),
    ),
    "AT": SteuersatzInfo(
        land_code="AT",
        land_name="Österreich",
        land_name_en="Austria",
        normal=Decimal("20"),
        ermaessigt=Decimal("10"),
        ermaessigt_2=Decimal("13"),
    ),
    "IE": SteuersatzInfo(
        land_code="IE",
        land_name="Irland",
        land_name_en="Ireland",
        normal=Decimal("23"),
        ermaessigt=Decimal("13.5"),
        ermaessigt_2=Decimal("9"),
        super_ermaessigt=Decimal("4.8"),
    ),
    # --- Südeuropa ---
    "IT": SteuersatzInfo(
        land_code="IT",
    ...
    "PT": SteuersatzInfo(
        land_code="PT",
        land_name="Portugal",
        land_name_en="Portugal",
        normal=Decimal("23"),
        ermaessigt=Decimal("13"),
        ermaessigt_2=Decimal("6"),
    ),
    "GR": SteuersatzInfo(
        land_code="GR",
        land_name="Griechenland",
        land_name_en="Greece",
        normal=Decimal("24"),
        ermaessigt=Decimal("13"),
        ermaessigt_2=Decimal("6"),
    ...
    "SI": SteuersatzInfo(
        land_code="SI",
        land_name="Slowenien",
        land_name_en="Slovenia",
        normal=Decimal("22"),
        ermaessigt=Decimal("9.5"),
        ermaessigt_2=Decimal("5"),
    ),
    # --- Nordeuropa ---
    "SE": SteuersatzInfo(
    ...
    "DK": SteuersatzInfo(
        land_code="DK",
        land_name="Dänemark",
        land_name_en="Denmark",
        normal=Decimal("25"),
        ermaessigt=Decimal("0"),
        waehrung="DKK",
    ),
    "FI": SteuersatzInfo(
        land_code="FI",
        land_name="Finnland",
        land_name_en="Finland",
        normal=Decimal("25.5"),
        ermaessigt=Decimal("14"),
        ermaessigt_2=Decimal("10"),
    ),
    # --- Osteuropa ---
    "PL": SteuersatzInfo(
    ...
    "CZ": SteuersatzInfo(
        land_code="CZ",
        land_name="Tschechien",
        land_name_en="Czech Republic",
        normal=Decimal("21"),
        ermaessigt=Decimal("12"),
        waehrung="CZK",
    ),
    ...
    "HU": SteuersatzInfo(
        land_code="HU",
        land_name="Ungarn",
        land_name_en="Hungary",
        normal=Decimal("27"),
        ermaessigt=Decimal("18"),
        ermaessigt_2=Decimal("5"),
        waehrung="HUF",
    ),
    "RO": SteuersatzInfo(
    ...
    "GB": SteuersatzInfo(
        land_code="GB",
        land_name="Vereinigtes Königreich",
        land_name_en="United Kingdom",
        normal=Decimal("20"),
        ermaessigt=Decimal("5"),
        waehrung="GBP",
        eu_mitglied=False,
        oss_faehig=False,
    ),
